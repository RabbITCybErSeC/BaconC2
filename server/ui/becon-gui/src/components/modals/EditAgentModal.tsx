...
const EditAgentModal: React.FC<EditAgentModalProps> = ({ isOpen, onClose, agent, onSave }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave(formData as Agent); // Assume formData is valid Agent for simplicity
  };
          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-6 gap-6">
              <div className="col-span-6">
                <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Agent Name</label>
                <input
                  type="text"
                  name="name"
                  id="name"
