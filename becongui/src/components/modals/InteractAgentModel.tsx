      ...
      {agent ? (
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="text-gray-800 dark:text-gray-100 text-sm space-y-1">
            ...
            <div className="mt-4">
              {activeTab === 'terminal' && (
                <div>
                  ...
                  <div className="bg-black text-green-400 font-mono text-sm p-3 rounded-lg h-64 overflow-y-auto border border-gray-700/50">
